...
CREATE TABLE `personaje` (
  ...
  CONSTRAINT `personaje_tipo` FOREIGN KEY (`id_tipo_personaje`) REFERENCES `tipo_personaje` (`id_tipo_personaje`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-06-25 17:15:08
