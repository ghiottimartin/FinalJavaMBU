...
CREATE TABLE `torneo` (
  ...
  KEY `torneo_usuario_idx` (`id_usuario`),
  KEY `torneo_personaje_idx` (`id_personaje`),
  KEY `torneo_combate_idx` (`id_combate`),
  CONSTRAINT `torneo_combate` FOREIGN KEY (`id_combate`) REFERENCES `combate` (`id_combate`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `torneo_personaje` FOREIGN KEY (`id_personaje`) REFERENCES `personaje` (`id_personaje`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `torneo_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-05-30 20:11:17
