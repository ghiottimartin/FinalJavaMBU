 ...
 %>
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<div class="dropdown-item">
								<button name="personaje" class="btn btn-default btn-sm">Crear Personaje</button>
							</div>
							<div class="dropdown-item">
	...
	<div class="contenedorLogin">
		<h1 align="center">Borrar Ataque</h1>
		<form method="post"
