		...
		<div class="col-lg-6 offset-lg-3">
			...
			<% 
				Cookie cookie = null;
		         ...
		         if(username != null){
		        	 %><input class="form-control" id="nombreUsuario" name="nombreUsuario" type="string" placeholder="Ingrese Nombre de Usuario" value="<%=username %>" /><%
		         }else {
			...
			<input class="form-control" id="password" name="password" type="password" placeholder="Ingrese Contraseña" value="" />
			<label>Repita contraseña:</label>
			<input class="form-control" id="password" name="passwordRepeated" type="password" placeholder="Reingrese Contraseña" value="" />
			<div class="botones">
			...
			<% 
			if(username != null){
	        	 %><span style="color: red;"><p>Las contraseñas deben coincidir</p></span><%
